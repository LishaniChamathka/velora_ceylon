...
const TOURS: Tour[] = [
  {
    ...
    alt: "A Historical Journey",
    rating: 4,
    reviews: 110,
    title: "A Historical Journey",
    desc: "Discover Sri Lanka's ancient kingdoms, sacred temples, UNESCO World Heritage Sites, and rich cultural heritage on an unforgettable historical journey.",
    price: "$899 P/P",
    priceNote: "From",
  },
  {
    ...
    days: 9,
    image: "/Beach-04.jpg",
    alt: "Southern Sands Voyage",
    rating: 4,
    reviews: 110,
    title: "Southern Sands Voyage",
    desc: "Relax along Sri Lanka's stunning southern coastline while enjoying beaches, whale watching, colonial landmarks, and unforgettable coastal adventures.",
    price: "$1,199 P/P",
    priceNote: "From",
  },
  {
    ...
    alt: "Wildlife, Culture & Beach Adventure",
    rating: 4,
    reviews: 110,
    title: "Wildlife, Culture & Beach Adventure",
    desc: "Experience Sri Lanka's perfect blend of wildlife safaris, cultural landmarks, scenic hill country, and tropical beach escapes.",
    price: "$1,499 P/P",
    priceNote: "From",
  },
  {
    ...
    alt: "Sri Lanka Wildlife Tours",
    rating: 4,
    reviews: 110,
    title: "Sri Lanka Wildlife Tours",
    desc: "Encounter elephants, leopards, exotic birdlife, and breathtaking landscapes across Sri Lanka's most spectacular national parks.",
    price: "$1,099 P/P",
    priceNote: "From",
  },
  {
    ...
    alt: "Scenic Beauty of Sri Lanka",
    rating: 4,
    reviews: 110,
    title: "Scenic Beauty of Sri Lanka",
    desc: "Explore misty mountains, tea plantations, waterfalls, scenic train journeys, and breathtaking natural landscapes across Sri Lanka.",
    price: "$749 P/P",
    priceNote: "From",
  },
  {
    ...
    days: 7,
    image: "/Ella-1.jpg",
    alt: "A Quick Escape to the Hills",
    rating: 4,
    reviews: 110,
    title: "A Quick Escape to the Hills",
    desc: "Enjoy a refreshing hill country getaway featuring Kandy, Nuwara Eliya, Ella, tea plantations, waterfalls, and scenic train rides.",
    price: "$899 P/P",
    priceNote: "From",
  },
  {
    id: 7,
    days: 7,
    image: "/Bentota-2-scaled.avif",
    alt: "Sunrise Shores Tour",
    rating: 4,
    reviews: 110,
    title: "Sunrise Shores Tour",
    desc: "Escape to Sri Lanka's beautiful eastern coastline with pristine beaches, snorkeling adventures, whale watching, and historic Trincomalee.",
    price: "$1,099 P/P",
    priceNote: "From",
  },
  {
    id: 8,
    days: 10,
    image: "/Waterfall-scaled.avif",
    alt: "Hill Country Retreat",
    rating: 4,
    reviews: 110,
    title: "Hill Country Retreat",
    desc: "Immerse yourself in Sri Lanka's peaceful hill country with tea estates, waterfalls, scenic railway journeys, and charming colonial towns.",
    price: "$1,399 P/P",
    priceNote: "From",
  },
  {
    id: 9,
    days: 7,
    image: "/Mirissa-scaled.avif",
    alt: "Eastern Blue Bliss",
    rating: 4,
    reviews: 110,
    title: "Eastern Blue Bliss",
    desc: "Relax on Sri Lanka's idyllic eastern beaches while exploring Trincomalee, Nilaveli, Pasikudah, vibrant coral reefs, and tropical coastal scenery.",
    price: "$899 P/P",
    priceNote: "From",
  },
];
